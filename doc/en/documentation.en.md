...
Unfortunately the parser is **bugged** and does not correctly interpret the comments. I created an [issue](https://github.com/glayzzle/php-parser/issues/1169#event-25724448614), but it turned out to be useless.
